...
export const createNewOrganizationModel = function (context: BaseContext): Organization {
    ...
    organization.companyVat = context.request.body.companyVat
    ...
    organization.accountType = context.request.body.accountType || ''
    ...
    organization.address.streetNumber = context.request.body.address.streetNumber || ''
    organization.address.streetBus = context.request.body.address.streetBus || ''
    organization.address.city = context.request.body.address.city || ''
    organization.address.postalCode = context.request.body.address.postalCode || ''
    organization.address.country = context.request.body.address.country || ''
...
export const createUpdateOrganizationModel = function (context: BaseContext): Organization {
    ...
    organization.sector = context.request.body.sector
    organization.employee = context.request.body.employee
    organization.address.streetName = context.request.body.address.streetName
    organization.address.streetNumber = context.request.body.address.streetNumber
    organization.address.streetBus = context.request.body.address.streetBus
    organization.address.city = context.request.body.address.city
